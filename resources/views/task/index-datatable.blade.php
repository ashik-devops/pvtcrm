...
@endsection
@section('task-create-edit-delete-scripts')')
    <script type="text/javascript">
        //creating task
...
//                responsive: false,
       ...
       $(document).ready(function(){
           function get_all_customer(){
               jQuery.get("{{ route('get-all-customer') }}", function(res){
                   data  = '<option>Select Customer</option>';
                   jQuery.each(res.customer,function(index,value){

                       data += '<option value="'+ value.id +'">'+ value.first_name + ' '+ value.last_name +'</option>';
                   });
                   $('#taskCustomerId').html(data);
               });
           }
