...
<form method="post" class="ajax-from"  data-parsley-validate id="taskForm">
    ...
    <div class="form-group {{ $errors->has('customer-id') ? ' has-error' : '' }}" id="customer-id">
        ...
        <select name="customer-id" id="taskCustomerId" class="form-control">
    ...
    <div class="form-group {{ $errors->has('due-date') ? ' has-error' : '' }}" id="due-date">
        ...
        <input id="taskDueDate" type="text" name="due-date" class="form-control" placeholder="Date" data-parsley-trigger="change focusout" data-parsley-required-message="Date is required" required value="{{old('due-date')}}">
