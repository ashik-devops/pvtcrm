...
class CompanyController extends Controller
{
    ...
    public function createCompany( Request $request){
       /* $data = [];
        $data['name'] = $request->company['companyName'];
        $data['email'] = $request->company['companyEmail'];
        $data['phone_no'] = $request->company['companyPhone'];
        $data['website'] = $request->company['companyWebsite']; */
      ...
      /*  $data['street_address_1'] = $request->company['streetAddress_1'];
        $data['street_address_2'] = $request->company['streetAddress_2'];
        $data['city'] = $request->company['city'];
        $data['state'] = $request->company['state'];
        $data['country'] = $request->company['country'];
        $data['zip'] = $request->company['zip'];
        $data['phone_no'] = $request->company['companyPhone'];
        $data['email'] = $request->company['companyEmail']; */
